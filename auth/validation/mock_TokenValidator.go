...
func (_m *MockTokenValidator) Validate(token string, purpose jwt.Purpose) (*v5.RegisteredClaims, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, jwt.Purpose) (*v5.RegisteredClaims, error)); ok {
	...
	if rf, ok := ret.Get(1).(func(string, jwt.Purpose) error); ok {
		r1 = rf(token, purpose)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockTokenValidator_Validate_Call) RunAndReturn(run func(string, jwt.Purpose) (*v5.RegisteredClaims, error)) *MockTokenValidator_Validate_Call {
	_c.Call.Return(run)
	return _c
}
